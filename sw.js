const CACHE="bookshelf-v15.9.1";
const STATIC=["./index.html","./reading-sessions.js?v=15.8","./reading-sessions.css?v=15.8","./worldbuilding.js?v=15.8.2","./worldbuilding.css?v=15.8.2","./character-network-layout.js?v=15.9.1","./character-network.js?v=15.9.1","./character-network.css?v=15.9.1","./manifest.webmanifest","./icon.svg"];
