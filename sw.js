const CACHE="bookshelf-v15.8";
const STATIC=["./index.html","./reading-sessions.js?v=15.8","./reading-sessions.css?v=15.8","./worldbuilding.js?v=15.8","./worldbuilding.css?v=15.8","./manifest.webmanifest","./icon.svg"];
